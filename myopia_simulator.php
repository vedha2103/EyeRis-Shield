...
<section class="section">
    ...
    <!-- Controls -->
    <div class="controls">
        <button class="active" onclick="setVision('myopia')">Myopia</button>
    ...
    <!-- Canvas image-->
    <div id="myopiaContainer" style="margin-top: 30px;">
        <img id="myopiaImage" alt="Myopia" style="max-width: 100%; border-radius: 10px; box-shadow: 0 4px 10px rgba(0,0,0,0.3); transition: filter 0.3s;">
    </div>

    <!-- Intensity Slider -->
    <div id="sliderContainer" style="margin-top: 40px;">
        <label style="color: black; font-size: 20px;">Myopia Intensity: <span id="intensityLabel">0</span> D</label><br>
        <input type="range" id="intensitySlider" min="0" max="6" step="1" value="0" list="myopiaTicks" />
            <datalist id="myopiaTicks">
    ...
    <script>
    const myopiaImage = document.getElementById('myopiaImage');
    ...
    intensitySlider.addEventListener('input', function () {
        ...
        myopiaImage.src = `images/myopia_${level}.png`;
    });
