...
<section class="section">
    ...
    <p style="text-align: center; margin: 0 auto; max-width: 800px;">
        This vision simulator provides a comparison between normal vision and the effects of declining eye health. Use the slider below to simulate astigmatism from normal to extreme astigmatism.
    </p>
    ...
    <div class="controls">
        ...
        <button class="active" onclick="setVision('astigmatism')">Astigmatism</button>
    </div>

    <!-- Canvas image -->
    <div id="astigmatismContainer" style="margin-top: 30px;">
        <img id="astigmatismImage" alt="Vision Simulation" style="max-width: 100%; border-radius: 10px; box-shadow: 0 4px 10px rgba(0,0,0,0.3); transition: filter 0.3s;">
    </div>

    <!-- Intensity Slider -->
<div id="sliderContainer" style="margin-top: 40px;">
    <label style="color: black; font-size: 20px;">Astigmatism Intensity: <span id="intensityLabel">Normal</span></label><br>
    
    <input type="range" id="intensitySlider" min="0" max="6" step="1" value="0" list="tickmarks" />
    
    <datalist id="tickmarks">
        <option value="0" label="Normal"></option>
        <option value="1" label="V.Mild"></option>
        <option value="2" label="Mild"></option>
        <option value="3" label="Moderate"></option>
        <option value="4" label="Severe"></option>
        <option value="5" label="V.Severe"></option>
        <option value="6" label="Extreme"></option>
    </datalist>
</div>
    ...
    intensitySlider.addEventListener('input', function () {
        ...
        astigmatismImage.src = `images/astigmatism_${level}.png`;
    });
